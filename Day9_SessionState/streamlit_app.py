...
#     """
#     <style>
#     /* Change the main application background color */
#     .stApp {
#         # background-color: #307ED3; /* A light blue color */
...
#         background-color: #0054a3; /* A dark blue color */
#     }

#     /* Change the primary color (used for buttons, sliders, etc.) */
#     :root {
#         --primary-color: #FF4B4B; /* Default Streamlit red, change as needed */
#     }
#     </style>
#     """,
